                ...
                <div class="card-body p-4 p-sm-5 login-form">
                    ...
                    <form id="login">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" name="email" class="form-control" id="email" value="admin@gmail.com" placeholder="name@example.com" autocomplete="off" onfocus="this.removeAttribute('readonly');" readonly>
                            <label for="email">Email address</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" name="password" class="form-control" id="password" value="admin@123" placeholder="Password" autocomplete="off" onfocus="this.removeAttribute('readonly');" readonly>
